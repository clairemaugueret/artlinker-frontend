    ...
    try {
      ...
      if (data.result) {
        ...
        setTimeout(() => {
          setSuccessMessage("");
          onClose();
        }, 1500); // Après 1,5 secondes, on efface le message et on ferme la modale
      } else {
    ...
    <Modal visible={isOpen} animationType="slide" transparent>
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          <Text style={globalStyles.h4}>Ajouter une pièce d'identité</Text>
          ...
          {successMessage ? (
            <Text
              style={[globalStyles.p, globalStyles.darkgreen, { marginTop: 8 }]}
            >
              {successMessage}
            </Text>
          ) : null}
          {errorMessage ? (
            <Text
              style={[globalStyles.p, globalStyles.darkred, { marginTop: 8 }]}
            >
              {errorMessage}
            </Text>
          ) : null}
